...
class CritiqueLoader(BaseLoader):
    ...
    """
    Critique document loader integration
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community.document_loaders import CritiqueLoader

            loader = CritiqueLoader(
                # required params = ...
                # other params = ...
            )
