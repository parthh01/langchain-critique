...
class ChatCritique(BaseChatModel):
    ...
    """Critique chat model integration.
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            Critique API key. If not passed in will be read from env var CRITIQUE_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatCritique.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatCritique.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatCritique supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatCritique supports async generation. Otherwise delete.
