...
class CritiqueToolInput(BaseModel):
    """Input schema for Critique tool.
...
class CritiqueTool(BaseTool):  # type: ignore[override]
    """Critique tool.
    ...
    args_schema: Type[BaseModel] = CritiqueToolInput
